...
(planned to move to SQLite instead, see `docs/superpowers/specs/2026-08-27-sqlite-storage-design.md`).
...
* current hour import/export energy is not persisted across service restarts (fix designed, not yet implemented - see the SQLite storage design doc)
